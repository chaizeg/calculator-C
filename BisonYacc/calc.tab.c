...
{
  "$end", "error", "$undefined", "INT", "VAR", "PLUS", "MINUS", "MULT",
  "DIV", "OPAR", "CPAR", "QUEST", "NEG", "$accept", "input", "exp", YY_NULLPTR
};
#endif
...
{
      -7,     0,    -7,    -7,    -7,    17,    17,    11,    -7,    22,
      17,    17,    17,    17,    -7,    -7,    -6,    -6,    -7,    -7
};
...
{
       2,     0,     1,     4,     5,     0,     0,     0,    10,     0,
       0,     0,     0,     0,     3,    11,     6,     7,     8,     9
};
...
{
       2,    12,    13,     3,     4,     0,     5,     8,     9,     6,
       0,     0,    16,    17,    18,    19,    10,    11,    12,    13,
       3,     4,    14,     5,     0,     0,     6,    10,    11,    12,
      13,     0,    15
};
...
{
       0,     7,     8,     3,     4,    -1,     6,     5,     6,     9,
      -1,    -1,    10,    11,    12,    13,     5,     6,     7,     8,
       3,     4,    11,     6,    -1,    -1,     9,     5,     6,     7,
       8,    -1,    10
};
